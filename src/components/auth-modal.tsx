        ...
        >
          ...
          <div className="relative z-10 space-y-6 max-sm:space-y-4">
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-full bg-white/95 py-4 max-sm:py-3 text-sm max-sm:text-xs font-semibold text-[#0F1B3D] transition-all hover:bg-white shadow-[0_4px_16px_rgba(0,0,0,0.1)]"
            >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-2xl bg-white/10 backdrop-blur-[20px] border border-white/[0.15] px-5 py-4 max-sm:px-4 max-sm:py-3 text-sm max-sm:text-xs text-white outline-none transition-all placeholder:text-white/30 focus:border-white/30 focus:bg-white/15"
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full rounded-full bg-white/95 py-4 max-sm:py-3 text-sm max-sm:text-xs font-semibold text-[#0F1B3D] transition-all hover:bg-white disabled:opacity-50 shadow-[0_4px_16px_rgba(0,0,0,0.1)]"
              >
