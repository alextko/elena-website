  ...
  return (
    <div className="font-[family-name:var(--font-inter)]">
      ...
      <section ref={heroRef} className={`relative flex flex-col items-center ${ref === "bills" ? "" : "justify-center h-dvh min-h-dvh max-md:min-h-[calc(100dvh+120px)] overflow-hidden"}`}>
        ...
        <div className={ref === "bills" ? "h-[80dvh] flex flex-col items-center justify-end pb-16 w-full shrink-0" : "contents"}>
        ...
        {ref === "bills" && (
          <div className="relative z-[3] w-full mt-8 pb-20" style={{
            ...
            <div className="flex animate-[scroll-left_60s_linear_infinite] will-change-transform [backface-visibility:hidden] mb-28">
              {[0, 1].map((set) => (
                <div key={set} className="flex gap-3 pr-3 shrink-0">
                  <div className="bg-white rounded-2xl px-6 pt-5 pb-4 w-[310px] shrink-0 shadow-[0_4px_12px_rgba(0,0,0,0.08)]">
                  ...
                  <div className="bg-white rounded-2xl px-6 pt-5 pb-4 w-[310px] shrink-0 shadow-[0_4px_12px_rgba(0,0,0,0.08)]">
                    <p className="text-[0.88rem] text-[#1C1C1E] leading-relaxed"><span className="font-bold">Maria</span> got her prior authorization for her inhaler approved after being rejected.</p>
                    <img src="/images/insurers/humana.svg" alt="Humana" className="h-4 mt-3" />
                  </div>
                  <div className="bg-white rounded-2xl px-6 pt-5 pb-4 w-[310px] shrink-0 shadow-[0_4px_12px_rgba(0,0,0,0.08)]">
                  ...
                  <div className="bg-white rounded-2xl px-6 pt-5 pb-4 w-[310px] shrink-0 shadow-[0_4px_12px_rgba(0,0,0,0.08)]">
                    <p className="text-[0.88rem] text-[#1C1C1E] leading-relaxed"><span className="font-bold">Andy</span> figured out the best insurance plan for him and his family.</p>
