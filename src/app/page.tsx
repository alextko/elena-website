...
function LandingPage() {
  ...
  return (
    <div className="font-[family-name:var(--font-inter)]">
      ...
      {/* HERO */}
      <section ref={heroRef} className="relative h-dvh min-h-dvh flex flex-col items-center justify-center overflow-hidden">
        {/* Gradient bg */}
        ...
        <div className="relative z-[4] text-center max-w-[700px] w-full px-6">
          ...
          <p className="text-[1.15rem] max-md:text-[1rem] font-light text-white/85 mt-4 tracking-wide">
            {hero ? hero.subtitle : (<>
              ...
              <span className="md:hidden">I&apos;m a healthcare expert that can call, email, and use a computer.</span>
            </>)}
          </p>
