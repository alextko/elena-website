        ...
        <div className="mx-auto max-w-[960px] flex items-center gap-16 max-md:flex-col max-md:text-center">
          ...
          <div className="shrink-0 flex flex-col items-center gap-5">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2.5 rounded-full bg-[#0F1B3D] px-7 py-3.5 shadow-[0_4px_16px_rgba(15,27,61,0.3)] hover:shadow-[0_6px_24px_rgba(15,27,61,0.4)] hover:scale-[1.02] transition-all"
            >
              ...
              <span className="text-white font-semibold text-[15px]">Download on the App Store</span>
            </a>
          </div>
        </div>
      </section>
